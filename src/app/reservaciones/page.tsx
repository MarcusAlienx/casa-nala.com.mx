...
export default function ReservacionesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F5E8D2] py-8 px-4">
      ...
      <section id="reservas" className="max-w-2xl mx-auto p-6 rounded-xl shadow-lg bg-[#fff] border border-[#D9D4CE] mb-16">
        <h1 className={`text-3xl font-bold text-[#6C3A3A] mb-3 text-center ${poiretOne.className}`}>
          Reservaciones
        </h1>
        <p className="text-[#9DA17B] mb-6 text-center">
          Aparta tu mesa en Casa NALA y disfruta de nuestra comida tradicional mexicana en el mejor ambiente.
        </p>
        <form className="flex flex-col gap-3">
          ...
          <button className="bg-[#6C3A3A] text-[#F5E8D2] rounded py-2 px-4 mt-4 font-semibold w-full hover:bg-[#9DA17B] transition" type="button"> {/* Cambiado type a button si no hay submit handler aún */}
            Reservar Mesa
          </button>
        </form>
      </section>
      ...
      <section id="ubicacion-mapa" className="max-w-4xl mx-auto mt-12 p-6 rounded-xl shadow-lg bg-[#fff] border border-[#D9D4CE]">
        <h2 className={`text-2xl font-bold text-[#6C3A3A] mb-4 text-center ${poiretOne.className}`}>
          Encuéntranos Aquí
        </h2>

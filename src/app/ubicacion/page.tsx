...
const MapDisplay = dynamic(() => import('@/components/MapDisplay'), {
  ssr: false,
  loading: () => <div style={{ height: '400px', width: '100%', background: '#f0f0f0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>Cargando mapa...</div>,
});
...
export default function UbicacionPage() {
  return (
    <main className="min-h-screen bg-[#F5E8D2] py-8 px-4">
      <section id="ubicacion" className="max-w-4xl mx-auto p-6 md:p-8 rounded-xl shadow-lg bg-[#fff] border border-[#D9D4CE]">
        <h1 className={`text-3xl lg:text-4xl font-bold text-[#6C3A3A] mb-6 text-center ${poiretOne.className}`}>
          Nuestra Ubicación y Contacto
        </h1>
        <p className="text-lg text-[#9DA17B] mb-6 text-center">
          Encuéntranos en: Av. Miguel López de Legaspi & Vasco de Gama, Col. 18 de Marzo, 44960 Guadalajara, Jal.
        </p>
        ...
        <div className="bg-[#FDFBF7] p-6 rounded-lg shadow-sm border border-[#EAE0D3] text-[#6C3A3A]">
          <h2 className={`text-2xl font-semibold text-center mb-4 ${poiretOne.className}`}>¿Tienes dudas o un pedido especial?</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center text-sm mb-6">
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs text-gray-600">Av. López de Legaspi & Vasco de Gama,<br/>Col. 18 de Marzo, 44960 Guadalajara, Jal.</p>
              <a 
            ...
            <div className="flex flex-col items-center">
              ...
              <a href="https://wa.me/523332531118" target="_blank" rel="noopener noreferrer" className="text-xs text-[#D7A556] hover:underline">
                +52 33 3253 1118
              </a>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <a href="mailto:ordenes@casanala.com.mx" className="text-xs text-[#D7A556] hover:underline">

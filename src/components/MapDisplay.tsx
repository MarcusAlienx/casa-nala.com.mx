...
const MapDisplay = () => {
  ...
  const address = "Av. Miguel López de Legaspi & Vasco de Gama, 18 de Marzo, 44960 Guadalajara, Jal.";
  ...
  if (!isMounted) {
    return <div style={{ height: '400px', width: '100%', background: '#f0f0f0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>Cargando mapa...</div>;
  }
